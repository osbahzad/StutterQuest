...
struct StoryCardView: View {
  ...
  var body: some View {
    VStack {
      ...
      .onAppear() {
        Task {
          print("Checking if story is completed for username: \(email)")
...
//private func check_if_completed(authViewMode:AuthViewModel) async {
//    print("here")
//    let completed = await authViewModel.fetch_completed_stories(email: email)
//    print("Completed stories: \(completed)")
//    isCompleted = completed.contains { completedStory in
//      completedStory == story.storyName
//    }
//  }
